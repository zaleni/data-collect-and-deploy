...
def sync_data(
    ...
    # print("indexes:", joint_indexes, eef_indexes, gripper_indexes)
...
def organize_data_from_single_run(save_folder):
    ...
    # print(f"len joints: {len(joints)}, len eefs: {len(eefs)}, len grippers: {len(grippers)}")
    # input("continue")
...
if __name__ == "__main__":
    ...
    u= list(organize_data_from_single_run("/home/pc3/data_collect/songlings/data/tmp/1/10-17AAA12:10:17"))
    print(len(u))
