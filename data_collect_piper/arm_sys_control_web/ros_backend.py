...
class ROSBackend:
    def __init__(self):
        ...
        self.pub_pick_up_the_plate = rospy.Publisher('/arm_control/pick_up_the_plate', Bool, queue_size=10)
    ...
    def pick_up_the_plate(self):
        self.pub_pick_up_the_plate.publish(True)
