...
sleep 1
#x7s
gnome-terminal -t "L" -x  bash -c "cd ${workspace}; cd ../..; cd ROS2/X5_ws; source install/setup.bash && ros2 launch arx_x5_controller open_vr_double_arm.launch.py; exec bash;"
sleep 0.1
#VR
