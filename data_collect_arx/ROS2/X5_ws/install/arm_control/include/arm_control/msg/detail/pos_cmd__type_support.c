...
void PosCmd__rosidl_typesupport_introspection_c__PosCmd_init_function(
...
void PosCmd__rosidl_typesupport_introspection_c__PosCmd_fini_function(void * message_memory)
{
  arm_control__msg__PosCmd__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember PosCmd__rosidl_typesupport_introspection_c__PosCmd_message_member_array[24] = {
  {
    "x",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers PosCmd__rosidl_typesupport_introspection_c__PosCmd_message_members = {
  "arm_control__msg",  // message namespace
  "PosCmd",  // message name
  24,  // number of fields
  sizeof(arm_control__msg__PosCmd),
  PosCmd__rosidl_typesupport_introspection_c__PosCmd_message_member_array,  // message members
  PosCmd__rosidl_typesupport_introspection_c__PosCmd_init_function,  // function to initialize message memory (memory has to be allocated)
  PosCmd__rosidl_typesupport_introspection_c__PosCmd_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t PosCmd__rosidl_typesupport_introspection_c__PosCmd_message_type_support_handle = {
  0,
  &PosCmd__rosidl_typesupport_introspection_c__PosCmd_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arm_control, msg, PosCmd)() {
  if (!PosCmd__rosidl_typesupport_introspection_c__PosCmd_message_type_support_handle.typesupport_identifier) {
    PosCmd__rosidl_typesupport_introspection_c__PosCmd_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &PosCmd__rosidl_typesupport_introspection_c__PosCmd_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
