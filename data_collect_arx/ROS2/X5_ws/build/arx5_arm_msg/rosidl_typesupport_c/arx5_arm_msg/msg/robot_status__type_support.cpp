...
#include "arx5_arm_msg/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _RobotStatus_type_support_symbol_names_t _RobotStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arx5_arm_msg, msg, RobotStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arx5_arm_msg, msg, RobotStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_arx5_arm_msg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, arx5_arm_msg, msg, RobotStatus)() {
  return &::arx5_arm_msg::msg::rosidl_typesupport_c::RobotStatus_message_type_support_handle;
}
