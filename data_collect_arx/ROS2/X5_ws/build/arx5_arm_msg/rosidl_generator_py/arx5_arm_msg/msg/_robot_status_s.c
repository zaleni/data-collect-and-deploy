...
bool arx5_arm_msg__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arx5_arm_msg.msg._robot_status.RobotStatus", full_classname_dest, 42) == 0);
  }
  arx5_arm_msg__msg__RobotStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // joint_cur
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT64);
      Py_ssize_t size = 7;
      double * dest = ros_message->joint_cur;
      for (Py_ssize_t i = 0; i < size; ++i) {
        double tmp = *(npy_float64 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(double));
      }
...
PyObject * arx5_arm_msg__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("arx5_arm_msg.msg._robot_status");
  ...
  {  // joint_cur
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 * dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double * src = &(ros_message->joint_cur[0]);
    memcpy(dst, src, 7 * sizeof(double));
    Py_DECREF(field);
  }
