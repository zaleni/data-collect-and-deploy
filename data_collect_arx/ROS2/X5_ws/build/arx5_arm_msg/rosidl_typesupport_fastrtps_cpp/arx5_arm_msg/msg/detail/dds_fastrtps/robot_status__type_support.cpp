...
#include "arx5_arm_msg/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 7;
    size_t item_size = sizeof(ros_message.joint_cur[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const arx5_arm_msg::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arx5_arm_msg::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &arx5_arm_msg::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
