...
#include "arx5_arm_msg/msg/detail/robot_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _RobotCmd__ros_msg_type = arx5_arm_msg__msg__RobotCmd;
...
static uint32_t _RobotCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arx5_arm_msg__msg__RobotCmd(
...
{
  return max_serialized_size_arx5_arm_msg__msg__RobotCmd(
    full_bounded, 0);
}
