  ...
  orbbec_camera_msgs__srv__GetCameraInfo_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    orbbec_camera_msgs__srv__GetCameraInfo_Request * data =
      (orbbec_camera_msgs__srv__GetCameraInfo_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!orbbec_camera_msgs__srv__GetCameraInfo_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          orbbec_camera_msgs__srv__GetCameraInfo_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  orbbec_camera_msgs__srv__GetCameraInfo_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    orbbec_camera_msgs__srv__GetCameraInfo_Response * data =
      (orbbec_camera_msgs__srv__GetCameraInfo_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!orbbec_camera_msgs__srv__GetCameraInfo_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          orbbec_camera_msgs__srv__GetCameraInfo_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
