...
bool orbbec_camera_msgs__msg__rgbd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("orbbec_camera_msgs.msg._rgbd.RGBD", full_classname_dest, 33) == 0);
  }
  orbbec_camera_msgs__msg__RGBD * ros_message = _ros_message;
  {  // header
...
PyObject * orbbec_camera_msgs__msg__rgbd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("orbbec_camera_msgs.msg._rgbd");
